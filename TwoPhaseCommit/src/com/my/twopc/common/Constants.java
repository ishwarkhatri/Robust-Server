...
public class Constants {
	...
	public static final String PARTICIPANT_TMP_TABLE_READ_QUERYY = "SELECT * FROM " + PARTICIPANT_TMP_TABLE_NAME + " WHERE TID = ?";
	public static final String PARTICIPANT_TMP_INSERT_QUERY = "INSERT INTO " + PARTICIPANT_TMP_TABLE_NAME + " (TID, FILE_NAME, FILE_CONTENT) VALUES (?, ?, ?);";
